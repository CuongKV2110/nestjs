...
exports.migrations1668508009193 = void 0;
class migrations1668508009193 {
    constructor() {
        this.name = 'migrations1668508009193';
    }
    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE \`permission_group\` (
        ...
        await queryRunner.query(`ALTER TABLE \`permission\` ADD CONSTRAINT \`FK_0248d0e8d737351620b03c3cfca\` FOREIGN KEY (\`permission_group_id\`) REFERENCES \`permission_group\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
...
exports.migrations1668508009193 = migrations1668508009193;
//# sourceMappingURL=1668508009193-migrations.js.map