...
export declare enum RequestCodeType {
    REGISTER = 1,
    CHANGE_PASSWORD = 2
}
export declare enum VerificationCodeStatus {
    INACTIVE = 0,
    ACTIVE = 1,
    USE = 2
}
...
export declare enum NotificationRedirectType {
    TEST = 1
}
export declare enum QueueProcessor {
    PUSH_NOTIFICATION = "PUSH_NOTIFICATION",
    SEND_MAIL = "SEND_MAIL"
}
export declare enum ReadNotification {
    UNREAD = 0,
    READ = 1
}
