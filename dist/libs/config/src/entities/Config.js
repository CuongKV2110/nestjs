...
__decorate([
    (0, typeorm_1.PrimaryColumn)({ type: 'varchar', name: 'key', length: 200 }),
    __metadata("design:type", String)
], Config.prototype, "key", void 0);
__decorate([
    (0, typeorm_1.Column)({ type: 'varchar', name: 'name', length: 255 }),
    __metadata("design:type", String)
...
__decorate([
    (0, typeorm_1.Column)('tinyint', { name: 'order', nullable: true }),
    __metadata("design:type", Number)
], Config.prototype, "order", void 0);
__decorate([
    (0, typeorm_1.Column)('tinyint', { name: 'is_system', nullable: true }),
    __metadata("design:type", Number)
], Config.prototype, "isSystem", void 0);
__decorate([
    (0, typeorm_1.Column)('bigint', { name: 'created_by', nullable: true, unsigned: true }),
    __metadata("design:type", Number)
